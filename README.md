...
What QuickRes does
- Instantly switch between your saved resolutions
- Create and manage custom resolution presets
- Quickly return to your native resolution
- Launch Valorant directly from QuickRes
- Access AMD and NVIDIA GPU controls
- Open useful Windows display tools
- Use hotkeys for even faster resolution switching
- See your current display configuration at a glance
- Lightweight — no Python installation required
No more digging through menus. Pick your resolution, hit Set, and play.
